            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぃ")]),
                    ),
                ),
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぅ")]),
                    ),
                ),
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぇ")]),
                    ),
                ),
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぉ")]),
                    ),
                ),
            ],
        ),
            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぎ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.top,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぐ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.right,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("げ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.bottom,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ご")]),
                    ),
                ),
            ],
        ),
            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("じ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.top,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ず")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.right,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぜ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.bottom,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぞ")]),
                    ),
                ),
            ],
        ),
            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぢ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.top,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("っ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.right,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("で")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.bottom,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ど")]),
                    ),
                ),
            ],
        ),
            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぴ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.top,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぷ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.right,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぺ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.bottom,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぽ")]),
                    ),
                ),
            ],
        ),
            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("び")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.top,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぶ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.right,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("べ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.bottom,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ぼ")]),
                    ),
                ),
            ],
        ),
            ...
            variations=[
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("（")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.top,
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ゅ")]),
                    ),
                ),
                FlickVariationData(
                    direction=FlickDirection.right,
                ...
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(start=[InputAction("ょ")]),
                    ),
                ),
            ],
        ),
                ...
                FlickVariationData(
                    ...
                    key=Variation(
                        ...
                        longpress_actions=LongpressAction(
                            start=[
                                SmartDeleteAction(
                                    direction=ScanDirection.backward, targets=[]
                                )
                            ]
                        ),
                    ),
